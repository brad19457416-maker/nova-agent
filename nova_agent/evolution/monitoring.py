...
class EvolutionMonitor:
    ...
    def record_evaluation(self, task_type: str, success: bool, 
    ...
    def record_evolution_step(self, before_rate: float, after_rate: float,
                            num_skills: int, description: str) -> None:
        """记录一次进化步骤"""
        ...
        if improvement > 0:
            logger.info(f"Evolution step successful: +{improvement:.2%} improvement, added {num_skills} skills")
        else:
