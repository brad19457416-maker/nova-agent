...
class InMemoryVectorStore(VectorStore):
    ...
    def search(self, query: str, top_k: int = 10) -> List[Dict]:
        ...
        for item in self.data:
            ...
            results.append({"text": item["text"], "similarity": sim, "metadata": item["metadata"]})
...
class ChromaDBVectorStore(VectorStore):
    ...
    def __init__(
        self, collection_name: str = "nova_agent_memories", persist_directory: str = "./data/chroma"
    ):
        try:
            import chromadb
    ...
    def search(self, query: str, top_k: int = 10) -> List[Dict]:
        ...
        if results["documents"] and results["documents"][0]:
            for i, doc in enumerate(results["documents"][0]):
                ...
                formatted.append({"text": doc, "similarity": similarity, "metadata": metadata})
